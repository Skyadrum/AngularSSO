...
@Component({
    selector: 'app-catalogo-tipo-tarea',
    templateUrl: './catalogoTiposTarea.component.html'
})
export class CatalogoTiposTareaComponent extends BaseComponent implements OnInit {
    ...
    catalogoController = "catalogoTiposTarea";
