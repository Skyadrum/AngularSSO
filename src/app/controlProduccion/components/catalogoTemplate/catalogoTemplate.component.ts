...
@Component({
    selector: 'app-catalogo-template',
    templateUrl: './catalogoTemplate.component.html'
})
export class CatalogoTemplateComponent extends BaseComponent implements OnInit {
    ...
    catalogoController = "catalogoTemplate";
