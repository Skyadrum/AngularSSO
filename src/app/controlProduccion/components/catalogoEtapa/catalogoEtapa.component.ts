...
@Component({
    selector: 'app-catalogo-etapa',
    templateUrl: './catalogoEtapa.component.html'
})
export class CatalogoEtapaComponent extends BaseComponent implements OnInit {
    ...
    that: any;
    catalogoController = "catalogoEtapas";
