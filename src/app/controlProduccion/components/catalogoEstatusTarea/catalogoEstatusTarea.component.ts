...
@Component({
    selector: 'app-catalogo-estatustarea',
    templateUrl: './catalogoEstatusTarea.component.html'
})
export class CatalogoEstatusTareaComponent extends BaseComponent implements OnInit {
    ...
    mensajeServiceComponent: any;
    that: any;
    catalogoController = "catalogoEstatusTarea";
    ...
    constructor(
        ...
        this.mensajeServiceComponent = mensajeService;
        this.that = this;
    }
